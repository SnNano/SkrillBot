    ...
    return (
        <section className="relative py-12 sm:py-20 md:py-24 lg:py-32">
            ...
            <div className="max-w-md px-4 mx-auto sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="relative px-6 py-10 overflow-hidden bg-white border-indigo-400 border-2 shadow-xl rounded-2xl sm:px-12 sm:py-20">
                    <div className="absolute inset-0 -mt-72 sm:-mt-32 md:mt-0">
                        <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 1463 360"  >
                            <path className="text-indigo-400/5" fill="currentColor" d="M-82.673 72l1761.849 472.086-134.327 501.315-1761.85-472.086z"  ></path><path className="text-indigo-400/10" fill="currentColor" d="M-217.088 544.086L1544.761 72l134.327 501.316-1761.849 472.086z"  ></path>
                        </svg>
                    </div>
                    <div className="relative">
                        <div className="flex flex-wrap justify-center w-full mx-auto sm:max-w-3xl">
                            {users && users.map((user, index) => {
                                return <img key={index} src={user.picture.medium} alt={user.name.first} className="border-2 border-indigo-400 h-[3.5rem] w-[3.5rem] mx-[1.5rem] rounded-full user-avatar" />
                            })}
                        </div>
                        <div className="mt-6 sm:mt-12 sm:text-center">
                            <h2 className="text-3xl font-black tracking-tight text-gray-900 sm:text-4xl md:text-5xl md:leading-tight md:max-w-4xl md:mx-auto">Join our community of fans that love SkrillBot<span className="text-indigo-400">.</span></h2>
                        </div>
