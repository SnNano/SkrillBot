...
const Facts = ({ showModal, setShowModal }) => {
    ...
    return (
        <>
            {showModal ? (
                <>
                    <div className="flex p-4 mb-4 text-black rounded-lg bg-white" role="alert">
                        ...
                        <button type="button" className="outline-none ml-auto -mx-1.5 -my-1.5 bg-indigo-50 text-indigo-500 rounded-lg focus:ring-2 focus:ring-indigo-400 p-1.5 hover:bg-indigo-200 inline-flex h-8 w-8" onClick={() => setShowModal(false)}>
