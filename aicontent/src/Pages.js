...
import { useRemainingWords } from "./hooks/useRemainingWords";
...
function Pages() {
    ...
    const remainingWords = useRemainingWords(state);
    useGoogleAuth(dispatch)
    useRemainingWords(state);
        ...
        <div className="font-poppins min-h-screen">
            <Router>
                <UserContext.Provider value={{ state, dispatch }}>
                    <RemainingWordsContext.Provider value={remainingWords}>
